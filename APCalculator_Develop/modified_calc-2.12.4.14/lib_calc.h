...
#define calc_scanerr_jmpbuf calc_error_jmpbuf
#define calc_matherr_jmpbuf calc_error_jmpbuf
EXTERN jmp_buf calc_error_jmpbuf;

EXTERN int calc_use_matherr_jmpbuf;
/* math_error() control jump point when calc_use_matherr_jmpbuf != 0 */
/* @krc@ EXTERN jmp_buf calc_matherr_jmpbuf; @krc@ */
...
/* @krc@ EXTERN jmp_buf calc_scanerr_jmpbuf; @krc@ */
